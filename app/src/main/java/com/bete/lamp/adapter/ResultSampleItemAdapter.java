...
public class ResultSampleItemAdapter extends RecyclerView.Adapter<ResultSampleItemAdapter.ViewHolder> {
    IItem iItem;
    ...
    public void setOnItemClickListener(ResultSampleItemAdapter.onItemClickListener onItemClickListener) {
    ...
    public ResultSampleItemAdapter(List<SampleItem> sampleitemList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_result_sample, parent, false);
