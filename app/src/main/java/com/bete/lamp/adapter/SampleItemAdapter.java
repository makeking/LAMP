...
public class SampleItemAdapter extends RecyclerView.Adapter<SampleItemAdapter.ViewHolder> {
    ...
    public void setOnItemClickListener(SampleItemAdapter.onItemClickListener onItemClickListener) {
    ...
    public SampleItemAdapter(List<SampleItem> sampleitemList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.itemtype.setText(String.valueOf(sampleItem.getType()));
