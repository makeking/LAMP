...
import static com.myutils.Canstant.INNER_CRASH_DIR;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private static final String PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + INNER_CRASH_DIR;
    /**
     * 文件名后缀
     */
...
//        }
        ...
        try{
            ...
            ActivityManager activityManager = (ActivityManager) AppApplication.getAppContext().getSystemService(Context.ACTIVITY_SERVICE);
            List<ActivityManager.AppTask> appTaskList = activityManager.getAppTasks();
            for (ActivityManager.AppTask appTask : appTaskList) {
                appTask.finishAndRemoveTask();
            }
            ActivityCollector.finishAll();
            ActivityManager manager = (ActivityManager) AppApplication.getAppContext().getSystemService(Context.ACTIVITY_SERVICE);
            manager.restartPackage(AppApplication.getAppContext().getPackageName());
